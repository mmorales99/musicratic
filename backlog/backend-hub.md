...
| ID | Task | Size | PRs | Tokens | Phase | Deps | Agent | Status |
|----|------|------|-----|--------|-------|------|-------|--------|
| HUB-010 | Hub code generation service (unique short alphanumeric, e.g. CAFELUNA23) | S | 1 | 20K | 1A | — | backend-module | 📋 Backlog |
| HUB-011 | QR code generation service (signed URL + QR image → Azurite blob) | M | 3 | 50K | 1A | HUB-010 | backend-module | 📋 Backlog |
| HUB-012 | Deep link generation (https://musicratic.app/join/{code}?sig={sig}) | S | 1 | 20K | 1A | HUB-010 | backend-module | 📋 Backlog |
| HUB-013 | Hub update + soft-delete commands | M | 2 | 35K | 1A | — | backend-module | 📋 Backlog |
| HUB-014 | Hub settings CRUD (update individual settings via command) | M | 2 | 35K | 1A | — | backend-module | 📋 Backlog |
...
| HUB-017 | List update + delete + reorder commands | M | 2 | 35K | 1A | — | backend-module | 📋 Backlog |
...
| HUB-021 | Hub pause / resume state transition commands | S | 1 | 20K | 1A | — | backend-module | 📋 Backlog |

## Phase 1F — Roles & Delegation

| ID | Task | Size | PRs | Tokens | Phase | Deps | Agent | Status |
|----|------|------|-----|--------|-------|------|-------|--------|
| HUB-030 | Hub member list + detail queries (with role info) | S | 1 | 20K | 1F | — | backend-module | 📋 Backlog |
