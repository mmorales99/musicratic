...
|----|------|------|-----|--------|-------|------|-------|--------|
| NTFY-001 | Notification entity (user_id, type, title, body, data_json, read_at, created_at) | S | 1 | 15K | 1B | — | backend-module | 📋 Backlog |
| NTFY-002 | Notification EF configuration + NotificationRepository | S | 1 | 20K | 1B | NTFY-001 | database | 📋 Backlog |
| NTFY-003 | NotificationDbContext (schema "notification") + DI registration | M | 2 | 30K | 1B | NTFY-002 | database | 📋 Backlog |
| NTFY-004 | WebSocket notification delivery (push to connected user sessions) | M | 3 | 50K | 1B | NTFY-001 | backend-module | 📋 Backlog |
| NTFY-005 | APNs push notification service (direct HTTP/2 to Apple) | L | 4 | 70K | 1C | NTFY-001 | backend-module | 📋 Backlog |
| NTFY-006 | FCM push notification service (direct HTTP to Google) | L | 4 | 70K | 1C | NTFY-001 | backend-module | 📋 Backlog |
