...
| TEST-003 | Shared test utilities (entity builders, fake repositories, test data factories) | M | 2 | 40K | 1A | — | testing | 📋 Backlog |
...
| ID | Task | Size | PRs | Tokens | Phase | Deps | Agent | Status |
|----|------|------|-----|--------|-------|------|-------|--------|
| TEST-005 | Integration test: Auth → Hub attachment flow (register → create hub → scan QR → attach) | L | 4 | 70K | 1A | HUB-015 | testing | 📋 Backlog |
| TEST-006 | Integration test: Full proposal → vote → skip → refund flow | L | 4 | 70K | 1C | VOTE-007, ECON-004 | testing | 📋 Backlog |

## Phase 1D–1G — E2E Tests

| ID | Task | Size | PRs | Tokens | Phase | Deps | Agent | Status |
|----|------|------|-----|--------|-------|------|-------|--------|
| TEST-007 | Angular E2E: Hub discovery → join → propose → vote → skip flow | L | 4 | 70K | 1D | WEB-014 | testing | 📋 Backlog |
| TEST-008 | Flutter E2E: Hub scan → propose → vote → skip flow | L | 4 | 70K | 1D | MOB-014 | testing | 📋 Backlog |
...
| TEST-010 | SonarQube CI integration (scanner in GitHub Actions, quality gate enforcement) | M | 2 | 40K | 1G | INFRA-014 | testing | 📋 Backlog |
