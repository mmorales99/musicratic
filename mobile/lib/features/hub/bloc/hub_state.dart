...
class HubState with _$HubState {
  ...
  const factory HubState.loaded({required List<Hub> hubs}) = HubStateLoaded;
  const factory HubState.creating() = HubStateCreating;
  const factory HubState.created({required Hub hub}) = HubStateCreated;
